    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->roles == 'ADMIN'){
                ...
                <x-responsive-nav-link href="{{ route('dashboard.transaction.index') }}" :active="request()->routeIs('dashboard.transaction')">
                    {{ __('Transaction') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link href="{{ route('dashboard.user.index') }}" :active="request()->routeIs('dashboard.user')">
                    {{ __('user') }}
                </x-responsive-nav-link>
            }
            @endif
